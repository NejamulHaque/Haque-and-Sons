...
async function getStats(): Promise<{
  ...
  try {
    ...
    const formattedApps: InternshipAppRow[] = appsResult.map((a) => ({
      ...
      projectZipUrl: a.projectZipUrl,
      projectStatus: a.projectStatus || "Not Submitted",
      projectGrade: a.projectGrade || "Distinction (Grade O)",
      projectRemarks: a.projectRemarks,
      projectSubmittedAt: a.projectSubmittedAt ? (a.projectSubmittedAt instanceof Date ? a.projectSubmittedAt.toISOString() : String(a.projectSubmittedAt)) : null,
      projectApprovedAt: a.projectApprovedAt ? (a.projectApprovedAt instanceof Date ? a.projectApprovedAt.toISOString() : String(a.projectApprovedAt)) : null,
      assignment1Status: a.assignment1Status || "Pending",
      assignment2Status: a.assignment2Status || "Pending",
      assignment3Status: a.assignment3Status || "Pending",
